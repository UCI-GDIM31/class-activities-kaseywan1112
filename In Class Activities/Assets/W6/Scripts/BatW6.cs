...
//Have a method that the BatManager can call that will make the bat STOP chasing the player, 
//and a different one that will make the bat START chasing the player.
//(Hint: make sure to put the keyword �public� in front of these methods so that BatManager can use them- we�ll talk about what this keyword means next class.)
